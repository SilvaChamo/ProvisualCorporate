    ...
    >
      <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-stretch">
        ...
        <div className="flex flex-col justify-center text-left py-2 lg:py-3">
          ...
          <p className="text-[#a21b7e] italic text-base md:text-lg mb-4">{service.subtitle}</p>
          <p className="text-gray-600 text-sm md:text-base leading-relaxed mb-5">{service.description}</p>
      ...
      <section className="w-screen relative left-1/2 -translate-x-1/2 bg-[#a21b7e]/[0.04] -mb-14 mt-14">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-10 py-12">
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {service.itemDetails.map((detail) => (
              <article key={detail.title} className="text-left">
                ...
                <p className="text-gray-600 text-sm md:text-base leading-relaxed pl-4 md:pl-5">
                  {detail.description}
                </p>
              </article>
            ))}
