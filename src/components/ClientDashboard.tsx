  ...
  return (
    <div className="flex h-screen bg-[#fafafa] text-gray-800 font-sans overflow-hidden">
      ...
      <aside className="w-60 bg-white border-r border-gray-100 flex flex-col shrink-0">
        ...
        <div className="p-3 bg-[#a21b7e]/5 border-t border-[#a21b7e]/10 shrink-0 flex items-center gap-3 w-full">
          {(() => {
            const parsed = (() => {
                                      ...
                                      <AnimatePresence>
                                        ...
                                        {activeFolderSubmenu === 'organizar' && (
                                          <motion.div
                                            ...
                                            exit={{ opacity: 0, scale: 0.95, x: 10 }}
                                            transition={{ duration: 0.1 }}
                                            className="absolute right-[100%] mr-1.5 top-0 w-44 bg-white border border-gray-100 rounded-sm shadow-[0_3px_15px_rgba(0,0,0,0.12)] z-50 py-1.5 text-left cursor-default font-sans"
                                            onClick={(e) => e.stopPropagation()}
                                          >
